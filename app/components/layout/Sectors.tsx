...
const Sectors = () => {
  return (
    <div className="flex flex-col min-h-max mx-auto p-7 md:p-32 border-b">
      <h1 className="font-thin pb-2 text-2xl md:text-4xl lg:text-5xl mb-16">
        Our sectors
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-5">
          ...
          <h1 className="text-lg md:text-xl lg:text-2xl">Aerospace</h1>
          <p className="max-w-md text-lg">
            With our modern facility, we produce aviation industry demands to
            high standards.
          </p>
        </div>
        <div>3</div>
